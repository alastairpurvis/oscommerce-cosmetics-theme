...
<!-- body_text //-->
    <td width="100%" valign="top" style="padding-left: 25px; padding-top: 25px;padding-bottom:0px; padding-right:70px"><?php echo tep_draw_form('login', tep_href_link(FILENAME_LOGIN, 'action=process', 'SSL')); ?><table border="0" width="100%" cellspacing="0" cellpadding="0">
      <tr>
...
?>
      <tr>
        <td class="smallText" style="padding-bottom:9px; padding-top:10px"><?php echo TEXT_VISITORS_CART; ?></td>
      </tr>
      <tr>
        <td><?php echo tep_draw_separator('pixel_trans.gif', '100%', '10'); ?></td>
      </tr>
...
?>
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
          <tr>
            <td width="50%" height="140" valign="top"><table border="0" width="100%" height="100%" cellspacing="1" cellpadding="8" class="infoBox">
              <tr class="infoBoxContents">
                <td><table border="0" width="100%" height="100%" cellspacing="0" cellpadding="2">
                  ...
                  <tr>
                    <td class="main" align=center><?php echo TEXT_NEW_CUSTOMER . '<br><br><Br><Br><Br>'; ?></td>
                  </tr>
                  <tr>
                    <td><?php echo tep_draw_separator('pixel_trans.gif', '100%', '10'); ?></td>
                  </tr>
