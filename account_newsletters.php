...
<!-- body_text //-->
    <td width="100%" valign="top"  style="padding-left: 30px;padding-top: 10px;padding-right: 60px;"><?php echo tep_draw_form('account_newsletter', tep_href_link(FILENAME_ACCOUNT_NEWSLETTERS, '', 'SSL')) . tep_draw_hidden_field('action', 'process'); ?><table border="0" width="100%" cellspacing="0" cellpadding="0">
      <tr>
