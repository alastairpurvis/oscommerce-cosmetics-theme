...
<!-- body_text //-->
    <td width="100%" valign="top"  style="padding-left: 30px;padding-top: 25px;padding-right: 60px;"><table border="0" width="100%" cellspacing="0" cellpadding="0">
      <tr>
...
?>
          <table border="0" width="100%" cellspacing="0" cellpadding="0"  style="padding-top: 15px">
            <tr>
...
?>
      ...
      <tr>
        <td style="padding-top: 40px"><table border="0" width="100%" cellspacing="0" cellpadding="0" class="infoBox">
          <tr class="infoBoxContents">
            <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
              <tr>
