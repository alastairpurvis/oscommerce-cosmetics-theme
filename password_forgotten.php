...
<!-- body_text //-->
    <td width="100%" valign="top"  style="padding-left: 25px; padding-top: 25px;padding-bottom:0px; padding-right:70px"><?php echo tep_draw_form('password_forgotten', tep_href_link(FILENAME_PASSWORD_FORGOTTEN, 'action=process', 'SSL')); ?><table border="0" width="100%" cellspacing="0" cellpadding="0">
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
          <tr>
            <td><h1>Forget your password?</h1></td> </tr>
        </table></td>
      </tr>
      <tr>
...
?>
      ...
      <tr>
        <td style="padding-top:10px"><?php echo tep_draw_separator('pixel_trans.gif', '100%', '10'); ?></td>
      </tr>
      <tr>
