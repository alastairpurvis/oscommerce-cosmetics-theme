...
<!-- body_text //-->
    <td width="100%" valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="0">
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="0" style="padding-left: 25px; padding-top: 25px;padding-bottom:0px; padding-right:16px">
          <tr>
            <td><h1><?php echo HEADING_TITLE_2; ?></h1></td>
            <td align=right><?php echo '<u><a class="inactive" href="' . tep_href_link(FILENAME_ADVANCED_SEARCH, tep_get_all_get_params(array('sort', 'page')), 'NONSSL', true, false) . '">< Advanced Search</a></u>'; ?></td>
          </tr>
        </table></td>
      </tr>
      <tr>
...
// create column list
  ...
  $select_str = "select distinct " . $select_column_list . " m.manufacturers_id, p.products_id, pd.products_name, p.products_price, p.products_short, p.products_tax_class_id, IF(s.status, s.specials_new_products_price, NULL) as specials_new_products_price, IF(s.status, s.specials_new_products_price, p.products_price) as final_price ";
