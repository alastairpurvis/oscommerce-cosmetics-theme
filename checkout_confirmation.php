...
<title><?php echo TITLE . ' - Checkout Confirmation'; ?></title>
...
<!-- body_text //-->
	     <td width="20"></td><td width="741" valign="top" style="background: url('images/checkoutbg.gif') no-repeat 0 10px;padding-left: 35px;padding-top: 35px;padding-right: 60px;"><table border="0" width="100%" cellspacing="0" cellpadding="0">
      <tr>
        <td>
<?php
...
<table border="0" width="100%" height=43 cellspacing="0" cellpadding="0">
			...
			<div style="height: 43px;background: url('images/checkoutsteps.png') no-repeat; background-position: 0 -88px"></div>
			</tr>
			</tr>
            </table></td>
      </tr>
      <tr>
        <td style="padding-top:25px"><?php echo tep_draw_separator('pixel_trans.gif', '100%', '10'); ?></td>
      </tr>
      <tr>
...
?>
              <tr>
                <td class="main" style="padding-top:25px"><?php echo '<b>' . HEADING_SHIPPING_METHOD . '</b> <a href="' . tep_href_link(FILENAME_CHECKOUT_SHIPPING, '', 'SSL') . '"><span class="orderEdit">(' . TEXT_EDIT . ')</span></a>'; ?></td>
              </tr>
              <tr>
...
?>
      ...
      <tr>
        <td class="main" style="padding-top:25px"></td>
      </tr>
      <tr>
        <td><?php echo tep_draw_separator('pixel_trans.gif', '100%', '10'); ?></td>
      </tr>
        ...
        <td><table border="0" width="100%" cellspacing="0" cellpadding="0" class="infoBox">
          <tr class="infoBoxContents">
            <td width="30%" valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td class="main" style="padding-top:25px"><?php echo '<b>' . HEADING_PAYMENT_METHOD . '</b> <a href="' . tep_href_link(FILENAME_CHECKOUT_PAYMENT, '', 'SSL') . '"><span class="orderEdit">(' . TEXT_EDIT . ')</span></a>'; ?></td>
              </tr>
              <tr>
                <td class="main"><?php echo $order->info['payment_method']; ?></td>
              </tr>
            </table></td>
            <td width="70%" valign="top" align="right"><table border="0" cellspacing="0" cellpadding="0">
<?php
...
?>
      <tr>
        <td class="main" style="padding-top:25px"><?php echo '<b>' . HEADING_ORDER_COMMENTS . '</b> <a href="' . tep_href_link(FILENAME_CHECKOUT_PAYMENT, '', 'SSL') . '"><span class="orderEdit">(' . TEXT_EDIT . ')</span></a>'; ?></td>
      </tr>
      <tr>
        <td><?php echo tep_draw_separator('pixel_trans.gif', '100%', '10'); ?></td>
      </tr>
