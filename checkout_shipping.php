...
<title><?php echo TITLE . ' - Checkout Delivery'; ?></title>
    ...
    <td width="20"></td><td width="741" valign="top" style="background: url('images/checkoutbg.gif') no-repeat 0 10px;padding-left: 35px;padding-top: 35px;padding-right: 60px;"><?php echo tep_draw_form('checkout_address', tep_href_link(FILENAME_CHECKOUT_SHIPPING, '', 'SSL')) . tep_draw_hidden_field('action', 'process'); ?><table border="0" width="100%" cellspacing="0" cellpadding="0">
      <tr>
        <td><table border="0" width="100%" height=43 cellspacing="0" cellpadding="0">
			...
			<div style="height: 43px;background: url('images/checkoutsteps.png') no-repeat; background-position: 0 0px"></div>
			</tr>
			</tr>
            </table></td>
      </tr>
      <tr>
        <td style="padding-top:20px"><?php echo tep_draw_separator('pixel_trans.gif', '100%', '10'); ?></td>
      </tr>
      <tr>
        ...
        <td><table border="0" width="100%" cellspacing="1" cellpadding="2" class="infoBox">
          <tr class="infoBoxContents">
            <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
              <tr>
                <td class="main" width="50%" valign="top"><?php echo 'Items will be delivered to the address on the right.<br><br><a class="active" href="' . tep_href_link(FILENAME_CHECKOUT_SHIPPING_ADDRESS, '', 'SSL') . '">Change Address</a>'; ?></td>
      ...
      <tr>
        <td style="padding-bottom:45px"><?php echo tep_draw_separator('pixel_trans.gif', '100%', '10'); ?></td>
      </tr>
<?php
...
?>
      ...
      <tr>
        <td style="padding-bottom:30px"><?php echo tep_draw_separator('pixel_trans.gif', '100%', '10'); ?></td>
      </tr>
<?php
  }
?>
      ...
      <tr>
        <td style="padding-bottom:25px"><?php echo tep_draw_separator('pixel_trans.gif', '100%', '10'); ?></td>
      </tr>
