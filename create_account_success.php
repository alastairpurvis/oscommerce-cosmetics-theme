...
*/
  ...
  if (sizeof($navigation->snapshot) > 0) {
    ...
    $origin_href = tep_href_link(FILENAME_LOGIN);
  }
  header("Location: ".$origin_href);
?>
...
<!-- body_text //-->
    <td width="100%" valign="top" style="padding-lefT: 45px; padding-top:25px;"><table border="0" width="100%" cellspacing="0" cellpadding="0">
      <tr>
