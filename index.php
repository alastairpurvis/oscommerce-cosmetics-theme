...
*/
  ...
  include("includes/malaysianredirect.php");
...
<body onload="StartPartnerSlideshow();" marginwidth="0" marginheight="0" topmargin="0" bottommargin="0" leftmargin="0" rightmargin="0">
<!-- header //-->
...
// We are asked to show only a specific category
        $listing_sql = "select " . $select_column_list . " p.products_id, p.products_short, p.manufacturers_id, p.products_price, p.products_tax_class_id, IF(s.status, s.specials_new_products_price, NULL) as specials_new_products_price, IF(s.status, s.specials_new_products_price, p.products_price) as final_price from " . TABLE_PRODUCTS . " p left join " . TABLE_SPECIALS . " s on p.products_id = s.products_id, " . TABLE_PRODUCTS_DESCRIPTION . " pd, " . TABLE_MANUFACTURERS . " m, " . TABLE_PRODUCTS_TO_CATEGORIES . " p2c where p.products_status = '1' and p.manufacturers_id = m.manufacturers_id and m.manufacturers_id = '" . (int)$HTTP_GET_VARS['manufacturers_id'] . "' and p.products_id = p2c.products_id and pd.products_id = p2c.products_id and pd.language_id = '" . (int)$languages_id . "' and p2c.categories_id = '" . (int)$HTTP_GET_VARS['filter_id'] . "'";
      } else {
// We show them all
...
?>
    <td>
    <table width="972" height="368" cellpadding="0" cellspacing="0" valign="top" style="padding-bottom:10px;position:relative">
    	<tr>
    	<td>
		<div style="position: relative; vertical-align:top; height:348px;">
	        	<?include('template/banners.php')?>
		</div>
	</td>
	</tr>
	</table>
	<? include('template/homecontent.php'); ?>
<?
 ///////////////////////////////////////////
 // END Home Page
 ///////////////////////////////////////////
