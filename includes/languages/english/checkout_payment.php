...
define('TEXT_SELECTED_BILLING_DESTINATION', 'The invoice will be sent to the address on the right.');
...
define('TABLE_HEADING_COMMENTS', 'More comments?');

define('TITLE_CONTINUE_CHECKOUT_PROCEDURE', 'Continue Checkout Procedure');
define('TEXT_CONTINUE_CHECKOUT_PROCEDURE', 'to make sure everything is correct.');
?>
