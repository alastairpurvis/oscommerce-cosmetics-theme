...
define('TEXT_SEE_ORDERS', 'You can view your order history by going to the <u><a class="inactive" href="' . tep_href_link(FILENAME_ACCOUNT, '', 'SSL') . '">\'My Account\'</a></u> page and clicking on <u><a class="inactive" href="' . tep_href_link(FILENAME_ACCOUNT_HISTORY, '', 'SSL') . '">\'History\'</a></u>.');
define('TEXT_CONTACT_STORE_OWNER', 'Please direct any questions you have to our <u><a class="inactive" href="' . tep_href_link(FILENAME_CONTACT_US) . '">support department</a></u>.');
