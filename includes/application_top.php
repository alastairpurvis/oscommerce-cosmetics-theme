...
define('FILENAME_RANGES', 'ranges.php');
define('FILENAME_ABOUT', 'about.php');
define('FILENAME_LIFESTYLE', 'lifestyle.php');
define('FILENAME_NEWS', 'news.php');
define('FILENAME_BA', 'beforeafter.php');
define('FILENAME_CELLCPR', 'cellcpr.php');
define('FILENAME_SSOLUTIONS', 'skinsolutions.php');
define('FILENAME_LEGAL', 'legal.php');
define('FILENAME_NUTRISSENTIALS', 'nutrissentials.php');
define('FILENAME_INSIDETRACK', 'supplements.php');
define('FILENAME_BECOME_PARTNER', 'become_partner.php');
