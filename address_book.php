...
<!-- body_text //-->
    <td width="100%" valign="top"  style="padding-left: 30px;padding-top: 10px;padding-right: 60px;"><table border="0" width="100%" cellspacing="0" cellpadding="0">
      <tr>
...
?>
      ...
      <tr>
        <td style="padding-top: 40px" class="main"></td>
      </tr>
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="0" class="infoBox">
          <tr class="infoBoxContents">
...
?>
              <tr>
                <td><table border="0" width="100%" cellspacing="0" cellpadding="0" style="padding-top:10px">
...
?>
      ...
      <tr>
        <td style="padding-top:10px"><table border="0" width="100%" cellspacing="0" cellpadding="0" class="infoBox">
          <tr class="infoBoxContents">
            <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
              <tr>
			  <td width=90% class="smallText"><?php echo sprintf(TEXT_MAXIMUM_ENTRIES, MAX_ADDRESS_BOOK_ENTRIES); ?>
                <td align="right"><form action="<? echo tep_href_link(FILENAME_ACCOUNT, '', 'SSL') ?>">
<button type=\"submit\" value=\"LIST\" style="padding: 5px;width: 80px; ">Back</button></form>
<?php
  if (tep_count_customer_address_book_entries() < MAX_ADDRESS_BOOK_ENTRIES) {
?>
                 <td align="right"><form action="<? echo tep_href_link(FILENAME_ADDRESS_BOOK_PROCESS, '', 'SSL') ?>">
<button type=\"submit\" value=\"LIST\" style="padding: 5px;width: 130px; ">Add Address</button></form></td>
<?php
  }
?>
              </tr>
