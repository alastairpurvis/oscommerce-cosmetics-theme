...
?>
<Tr>
					  <td><br><br><i> <? echo  sprintf(TEXT_REVIEW_RATING, tep_image(DIR_WS_IMAGES . 'stars_' . $reviews['reviews_rating'] . '.gif', sprintf(TEXT_OF_5_STARS, $reviews['reviews_rating'])), sprintf(TEXT_OF_5_STARS, $reviews['reviews_rating'])) . '</i>'; ?></td>
                        </Tr>
              <tr>
                    <td class="smallText">Posted <?php echo tep_date_short($reviews['date_added']); ?> by <? echo $reviews['customers_name']; ?></td>
              </tr>
              <tr>
    
				 <td valign="top" class="main"><?php echo tep_break_string(tep_output_string_protected($reviews['reviews_text']), 60, '-<br>') . ((strlen($reviews['reviews_text']) >= 100) ? '' : '');?><br></br>
<?php echo '<a href="' . tep_href_link(FILENAME_PRODUCT_REVIEWS_INFO, 'products_id=' . $product_info['products_id'] . '&reviews_id=' . $reviews['reviews_id']) . '"><u><b>Read the rest</b></u></a>';?></td><?php echo tep_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
</td>
</td>
              </tr>
              <tr>
