...
// Use our photoshop template for correct borders
// Banner images are stored in the "images/banners" directory
////////////////////////////////////////////////////////////////////////////
...
<div class="images"> 
    ...
    <div>
		<table cellpadding="0" cellspacing="0">
			<tr>
				<td alt="Cell CPR." valign="top" style="background: url('images/banners/homepage_23.jpg') no-repeat; width: 972px; height: 348px; padding-left: 237px; padding-top:120px; padding-right:360px">
				<h2 style="font-size: 20px">In 2 weeks, clinically proven:</h2>
 <ul style="font-size: 14px"><li>31% decrease in wrinkles and fine lines.</li><li>27% increase in skin hydration.</li><li>Improved skin elasticity, brightness, radiance, and tone.</li></ul></p><br>
