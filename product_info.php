...
<div class="panes" id="panes"> 
	...
	<?php echo stripslashes($product_info['products_description']); ?>		<table border="0" width="100%" cellspacing="0" cellpadding="0" valign=center>
				<td align=right style="padding-bottom: 20px; padding-right: 5px; padding-top: 10px">
				<img src="images/nottestedonanimals.gif" />
				</td>
				</table></div> 
	<div style="vertical-align:top">
...
document.cart_quantity.reset()
				...
				<td width=90% align=right style="padding-right: 14px">
